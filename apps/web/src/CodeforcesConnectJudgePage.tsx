...
export function CodeforcesConnectJudgePage(): React.JSX.Element {
    ...
    <main className="flex min-h-screen items-center justify-center px-5 py-8 text-zinc-100 sm:px-8">
      <section className="mx-auto flex w-full max-w-2xl flex-col gap-6">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">Save credentials for syncing Codeforces</p>
        </div>

        <CodeforcesConnectJudgeForm onChangeProvider={() => void navigate({ to: "/connect-judges" })} />
      </section>
    </main>
  );
}
