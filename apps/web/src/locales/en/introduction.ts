export const introduction = {
  ...
  setup: {
    ...
    windowsChanges: "Installs or reuses VS Code, installs MSYS2 UCRT64 GCC/g++ and Microsoft C/C++, adds the compiler and VS Code to your user PATH, and configures IntelliSense to use the compiler.",
    windowsCommand: "Set-ExecutionPolicy -Scope Process Bypass; & \"$HOME\\Downloads\\install-cpp-vscode.ps1\"",
