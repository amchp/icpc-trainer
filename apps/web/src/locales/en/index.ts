...
export const en = { auth, common, contestFinder, contests, findProblems, introduction, judges, leaderboard, playground, programmingFundamentals, resources, roster, shell, timeComplexity, upsolving } as const;
