...
export const es = { auth, common, contestFinder, contests, findProblems, introduction, judges, playground, programmingFundamentals, resources, roster, shell, timeComplexity, upsolving } as const;
