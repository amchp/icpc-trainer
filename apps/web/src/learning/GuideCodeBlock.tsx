...
export function GuideCodeBlock<const S extends GuideTraceInputSchema = GuideTraceInputSchema>(
  props: GuideCodeBlockProps<S>
): React.JSX.Element {
...
function TraceState({ frame }: { readonly frame: GuideTraceFrame }): React.JSX.Element {
  const { t } = useTranslation("programmingFundamentals");
  return (
